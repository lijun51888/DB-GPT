...
const ChatContainer = () => {
  ...
  return (
    <>
      ...
      /> */}
      <div className='flex flex-1 flex-wrap overflow-hidden relative'>
        <div
          className={classNames('flex flex-1 flex-col overflow-hidden', {
            'px-0 h-1/2 w-full xl:w-auto xl:h-full border-t xl:border-t-0 xl:border-r dark:border-gray-800':

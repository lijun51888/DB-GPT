...
const ChatHeader: React.FC<{ isScrollToTop: boolean }> = ({ isScrollToTop }) => {
  ...
  const topHeaderContent = () => {
    return (
      <header className='flex items-center justify-between w-5/6  h-14 bg-[#ffffffb7] dark:bg-[rgba(41,63,89,0.4)] mx-auto  px-8 transition-all duration-500 ease-in-out'>
        <div className='flex items-center'>
          ...
          <div className='flex items-center text-base text-[#1c2533] dark:text-[rgba(255,255,255,0.85)] font-semibold gap-2'>
            <span>
              <span>Boost Your BIS Data - 你的商业数据智能挖掘平台</span>
            </span>
          </div>
        </div>
        {/* <div
